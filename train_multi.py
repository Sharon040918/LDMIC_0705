...
def main(argv):
    ...
    train_dataset = MultiCameraImageDataset(ds_type='train', ds_name=args.data_name, root=args.dataset, crop_size=args.patch_size, num_camera=args.num_camera)
    test_dataset = MultiCameraImageDataset(ds_type='test', ds_name=args.data_name, root=args.dataset, crop_size=args.patch_size, num_camera=args.num_camera)
